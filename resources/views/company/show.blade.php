...
<section class="m-3 lg:m-10">
    <div class="grid grid-cols-12 gap-4 mb-4">
        <div class="col-span-12 xl:col-span-6">
            <div class="flex flex-col 2xl:flex-row text-center shadow-md border border-gray-200 rounded-lg p-6 w-full h-full dark:border-gray-700 bg-base-200 dark:bg-base-300">
        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="flex flex-col justify-between shadow-md border border-gray-200 rounded-lg p-6 h-full text-center dark:border-gray-700 bg-base-200 dark:bg-base-300">
            ...
            <div class="w-full">
                <ul class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row">
                    <li class="-mb-px mr-2 last:mr-0 flex-auto text-center">
                        <a class="text-xs font-bold uppercase px-5 py-3 shadow-md rounded block leading-normal cursor-pointer text-neutral bg-white" href="#">
